...
return array(
    // Zend_Validate_Alnum
    "Invalid type given. String, integer or float expected" => "Byl zadán chybný typ. Byl oèekáván øetìzec nebo celé èi desetinné èíslo",
    "'%value%' contains characters which are non alphabetic and no digits" => "'%value%' neobsahuje pouze písmena a èíslice",
    "'%value%' is an empty string" => "'%value%' je prázdný øetìzec",

    // Zend_Validate_Alpha
    "Invalid type given. String expected" => "Chybný typ. Byl oèekáván øetìzec",
